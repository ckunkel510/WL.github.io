...
document.addEventListener('DOMContentLoaded', function () {
  var divElement = document.getElementById('ctl00_PageBody_productDetail_ctl01');

  if (divElement) {
    var iframeElement = divElement.querySelector('iframe');
    if (iframeElement) {
      iframeElement.id = 'DescriptionIframe'; // Change 'newIframeId' to your desired ID
    }
  }
});
...
<script>
document.addEventListener('DOMContentLoaded', function () {
  var divElement = document.getElementById('ctl00_PageBody_productDetail_ctl02');
