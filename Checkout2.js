...
(function(){
  ...
  // 2) Special instructions field + wrapper
  ...
  // 6) Set up min-dates on the native date inputs
  ...
  // 7) Prevent Sundays and past dates
  ...
  // 9) Update the special instructions text
  ...
  // 10) Show/hide pickup vs delivery
  function onShip(){
    if (rbPick.checked) {
