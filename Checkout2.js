$(document).ready(function() {
  ...
  if ($(".SaleTypeSelector").length) {
    // (If desired, you could remove the original shipping method section.)
    ...
    function updateShippingStyles(selectedValue) {
      ...
      if (selectedValue === "rbDelivered") {
        ...
        // Automatically check the billing radio button when Pickup is selected.
  ...
  // ===================================================
  // 3. Address Selector Behavior & Read-Only Display Containers
  // ===================================================
  var shippingAddress = "";
  if ($("#ctl00_PageBody_CustomerAddressSelector_SelectAddressLinkButton").length) {
    ...
    if (addressEntries.length > 0) {
      ...
      // Populate the (visible) delivery input fields.
      ...
      // Set the state dropdown by finding the option whose text matches the parsed state.
      ...
      // Append read-only display containers to the 6th and 7th checkout containers.
    ...
    // "Add New Address" button (reveals input fields).
  ...
  // ===================================================
  // 6. Billing Address Radio Button Handler
  // ===================================================
  $(document).on("change", "#billingAddressRadio", function() {
    if ($(this).is(":checked")) {
      ...
      console.log("Copied values to invoice address fields:", deliveryAddressLine, deliveryCity, deliveryPostcode);
  ...
  // ===================================================
  // 7. Internal Edit Buttons Handlers
  // ===================================================
