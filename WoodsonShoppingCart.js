(function () {
  ...
  const SHIPPING_PROMO_SCRIPT_URL = 'https://ckunkel510.github.io/WL.github.io/UpsShippingPromo.js?v=20260707-bridge-4';
  const STORE_ORIGINS = {
  ...
  function loadShippingPromoScript() {
    ...
    script.async = true;
    script.setAttribute('data-wl-ups-shipping-promo', 'true');
