...
(function(){
  ...
  (function injectCSS(){
    ...
    const css = `
      ...
      .wl-chipbtn{ border:1px solid var(--wl-border); border-radius:999px; padding:7px 12px; font-weight:normal; font-size:12px; cursor:pointer; background:#6b0016; color:white; max-height:30px; }
